...
namespace Zetcil
{
	...
	public class ZetInputMultiDragListener : MonoBehaviour, IPointerDownHandler, IPointerUpHandler
	{
		private const float POINTERS_VALIDATION_INTERVAL = 5f;

		private List<IZetInputDraggableMultiTouch> listeners = new List<IZetInputDraggableMultiTouch>( 1 );
		private IZetInputDraggableMultiTouch activeListener;
		...
		public void AddListener( IZetInputDraggableMultiTouch listener )
		{
		...
		public void RemoveListener( IZetInputDraggableMultiTouch listener )
		{
