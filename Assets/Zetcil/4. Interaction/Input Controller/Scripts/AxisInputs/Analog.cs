...
namespace Zetcil
{
	public class Analog : MonoBehaviour, IZetInputDraggable
	{
...
#pragma warning restore 0649
		...
		private void Start()
		{
			ZetInputDragListener eventReceiver;
			if( !isDynamicJoystick )
				eventReceiver = thumbTR.gameObject.AddComponent<ZetInputDragListener>();
			else
			{
				...
				eventReceiver = dynamicJoystickMovementArea.gameObject.AddComponent<ZetInputDragListener>();
			}
