...
namespace Zetcil
{
	public class SteeringWheel : MonoBehaviour, IZetInputDraggable
	{
		public ZetInput.AxisInput axis = new ZetInput.AxisInput( "Horizontal" );
        public bool isPress;
		...
		private void Awake()
		{
			...
			ZetInputDragListener eventReceiver = gameObject.AddComponent<ZetInputDragListener>();
